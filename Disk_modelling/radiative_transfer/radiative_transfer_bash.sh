...
RESULTS_DIR="/media/admin1/DATA/Input_Params_bashscript/Disk_modelling/results"
RT_EXECUTABLE="/media/admin1/DATA/Input_Params_bashscript/Disk_modelling/radiative_transfer/radiative_transfer"
LOG_DIR="/media/admin1/DATA/Input_Params_bashscript/Disk_modelling/logs_rt"
