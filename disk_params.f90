...
contains
    ...
    subroutine get_params(params, disk_id)
        ...
        params%mixnames(1) = 'silicate3.Kappa'
        params%mixnames(2) = 'silicate4.Kappa'
        
        allocate(params%mixspecs(2,2))
        params%mixspecs(1,1) = 'silicate_100.Kappa'
        params%mixspecs(1,2) = 'silicate1.Kappa'
        params%mixspecs(2,1) = 'silicate_100.Kappa'
        params%mixspecs(2,2) = 'silicate1.Kappa'
        ...
        params%infile(2) = 'silicate_0.1.Kappa'
